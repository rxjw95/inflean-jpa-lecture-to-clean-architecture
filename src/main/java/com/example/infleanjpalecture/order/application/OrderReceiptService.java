...
@Service
public class OrderReceiptService implements OrderReceiptUseCase {

    private final OrderPersistPort orderPersistPort;
    private final MemberLoadPort memberLoadPort;
    private final ItemLoadPort itemLoadPort;

    public OrderReceiptService(OrderPersistPort orderPersistPort, MemberLoadPort memberLoadPort, ItemLoadPort itemLoadPort) {
